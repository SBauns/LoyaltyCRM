...
$audience = Read-Host "Enter Audience"
$issuer = Read-Host "Enter Issuer"
...
dotnet user-secrets set "JwtSettings:Audience" "$audience" --project "./LoyaltyCRM.Api"
dotnet user-secrets set "JwtSettings:Issuer" "$issuer" --project "./LoyaltyCRM.Api"
